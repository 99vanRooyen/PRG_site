...
function Services() {
  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center bg-[url('./assets/Home-Bg.jpg')] bg-repeat bg-center text-black">
        {/* Navbar component */}
        <Navbar />

        <h1 className="text-center text-5xl font-extrabold py-6 tracking-wide">
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#9fb658] to-[#545f2c]">SERVICES</span>
        </h1>
