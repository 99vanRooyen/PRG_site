...
const LogoSlider = () => {
  ...
  const categories = [
    <img src='/assets/rozees.svg' className="inline w-24 md:w-40"/>,
    <img src='/assets/Gentlemans_biltong.svg' className="inline w-24 md:w-40"/>,
    <img src='/assets/LAB_plumbing.svg' className="inline w-24 md:w-40"/>,
    <img src='/assets/Braai_poot.svg' className="inline w-24 md:w-40"/>,
