...
export default function Services() {
  ...
  const services = [
    ...
    },
    {
      icon: (
        <img
          src="/premotionalprinting.png"
          alt="Promotional printing icon"
          className="w-10 h-10 object-contain"
          loading="lazy"
        />
      ),
    ...
    // ✅ NEW: Screen Printing block
    {
      icon: (
        <img
           src="/sublimation.png"
          alt="Screen printing icon"
          className="w-10 h-10 object-contain"
          loading="lazy"
        />
      ),
      ...
      description: [
        "High quality screen printing for apparel and branded items.",
        "Perfect for T-shirts, hoodies, workwear, uniforms and bulk orders.",
      ],
    },
  ];
    ...
    <section className="relative pt-12 md:pt-16 pb-16">
      ...
      <div className="relative max-w-full mx-auto px-6 z-10">
        ...
        <div className="mb-20 md:mb-24">
          <p className="text-[#3a4127] text-sm md:text-base tracking-wide uppercase leading-tight">
            SERVICES
          </p>
          <h2 className="text-3xl md:text-4xl font-bold text-[#596140] text-shadow-md leading-tight">
            SERVICES | PROVIDE
          </h2>
        </div>

        {/* ✅ Changed lg:grid-cols-4 -> lg:grid-cols-5 for 5 blocks */}
        <div className="grid grid-cols-1 items-center md:grid-cols-2 lg:grid-cols-5 gap-y-24 md:gap-y-20 lg:gap-y-16 gap-x-8 pt-10">
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="teardrop">
                <div className="teardrop-icon">{service.icon}</div>
              </div>
              ...
              <Link
                to="/services"
                className="mt-auto pt-2 text-black font-medium hover:underline"
