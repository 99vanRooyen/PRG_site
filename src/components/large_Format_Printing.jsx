...
function Large_Format_Printing() {
  ...
  const categories = [
    <img src="/assets/LFP1.png" className="inline w-24 md:w-40 h-auto object-contain" alt="Large format sample 1" />,
    <img src="/assets/LFP2.png" className="inline w-24 md:w-40 h-auto object-contain" alt="Large format sample 2" />,
    <img src="/assets/LFP3.jpg" className="inline w-24 md:w-40 h-auto object-contain" alt="Large format sample 3" />,
    <img src="/assets/LFP4.jpg" className="inline w-24 md:w-40 h-auto object-contain" alt="Large format sample 4" />,
    <img src="/assets/LFP5.png" className="inline w-24 md:w-40 h-auto object-contain" alt="Large format sample 5" />,
    <img src="/assets/LFP6.jpg" className="inline w-24 md:w-40 h-auto object-contain" alt="Large format sample 6" />,
    <img src="/assets/LFP7.jpg" className="inline w-24 md:w-40 h-auto object-contain" alt="Large format sample 7" />,
    <img src="/assets/LFP8.jpg" className="inline w-24 md:w-40 h-auto object-contain" alt="Large format sample 8" />,
    <img src="/assets/LFP9.jpg" className="inline w-24 md:w-40 h-auto object-contain" alt="Large format sample 9" />,
    <img src="/assets/LFP10.jpg" className="inline w-24 md:w-40 h-auto object-contain" alt="Large format sample 10" />,
  ];
    ...
    <>
      ...
      >
        ...
        <p className="text-center mt-2">
          Large format printling lets you showcase your brand on a bigger scale with bold, high quality visuals.
        </p>

        <br />

        <p className="text-center">
          This type of printing delivers high quality, full color images with sharp details, making it perfect for
          impactful visual communication. Large format printers can print on a wide variety of materials, including
          paper, vinyl, canvas, fabric, foam board, and even rigid substrates.
        </p>

        <br />

        <p className="text-center">
          Common products include banners, posters, billboards, signage, vehicl wraps, trade show displays, wall and
          window graphics, floor decals, backdrops, point of sale displays, blueprints, architectural drawings, and
          custom wallpapers.
        </p>
        ...
        <p className="text-center">
          Large format printing is widely used in advertising, branding, events, retail, and construction industries.
        </p>
        ...
        <img
          data-reveal
          data-delay="120ms"
          src="/assets/Large_Format_Printing.png"
